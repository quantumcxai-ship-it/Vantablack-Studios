        ...
        <div className="flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="flex-1 max-w-2xl">
            <div className="flex flex-col lg:space-y-20">
              ...
              {/* Features List */}
              <AnimatedContainer direction="left" delay={0.3} className="space-y-6 max-w-md order-3">
          ...
          <AnimatedItem direction="right" delay={0.2} className="hidden lg:block flex-1 max-w-2xl my-8">
